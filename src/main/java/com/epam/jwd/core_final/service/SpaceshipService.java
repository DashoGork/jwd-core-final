...
public interface SpaceshipService {
    ...
    void assignSpaceshipOnMission(Spaceship crewMember) throws UnasignedSpaceshipException;

    // todo create custom exception for case, when crewMember is not able to be created (for example - duplicate.
    // spaceship unique criteria - only name!
    Spaceship createSpaceship(Spaceship spaceship) throws ImpToCreateSpaceshipException;
}
