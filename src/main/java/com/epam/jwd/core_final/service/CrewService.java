...
public interface CrewService {
    ...
    void assignCrewMemberOnMission(CrewMember crewMember) throws UnasignedCrewMemberException;

    // todo create custom exception for case, when crewMember is not able to be created (for example - duplicate.
    // crewmember unique criteria - only name!
    CrewMember createCrewMember(CrewMember spaceship) throws ImpToCreateCrewMemberException;
}